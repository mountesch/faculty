package backend.tclass.reflection.di

import backend.tclass.reflection.annotations.Autowired
import backend.tclass.reflection.annotations.Component
import backend.tclass.reflection.services.commands.Command
import backend.tclass.reflection.services.commands.CommandDefinition
import backend.tclass.reflection.services.commands.CommandHandler
import java.io.File
...
class KotlinInjectionFactory(private val basePackage: String) {
    ...
    fun <T : Any> injectMembers(obj: T): T {
        ...
        for (prop in kClass.members) {
            ...
            if (prop !is kotlin.reflect.KProperty<*>) continue
